...
def train_model(criterion, epoch, model, model_type, optimizer, train_iter, batch_size, clip_val, log_interval,
                scheduler=None):
    """
    ...
    for batch_idx, data in enumerate(train_iter, 1):
        ...
        if model_type == 'LSTMAE_CLF':
            ...
            # Calculate loss
            # print(model_out.device, data.device)
